    ...
    <div className="flex flex-col items-center justify-center min-h-screen min-h-[100dvh] bg-bg-primary p-6 text-center overflow-y-auto safe-top safe-bottom">
      ...
      >
        ...
        <p className="text-muted mb-8 text-sm">
          Track your self-care journey with friends. Earn stickers, stay healthy!
        </p>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="w-full py-3 min-h-[48px] bg-bg-primary text-brand-ink border-2 border-border-subtle rounded-xl font-bold text-sm flex items-center justify-center gap-2 hover:border-brand-primary/40 transition-colors active:scale-[0.98]"
          >
